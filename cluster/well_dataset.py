...
def open_cluster_well_interval_form(item: QListWidgetItem | None = None) -> None:
    ...
    try:
        ...
        # Do not resolve the well again through the mutable main-list selection:
        # this list item is the authoritative source for the double click.
        open_well_log_form(well_id=well_id)
