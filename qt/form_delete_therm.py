...
class Ui_Form_delete_therm_by_date(object):
    def setupUi(self, Form_delete_therm_by_date):
        ...
        self.checkBox_all_hwell = QtWidgets.QCheckBox(Form_delete_therm_by_date)
        self.checkBox_all_hwell.setObjectName("checkBox_all_hwell")
        self.gridLayout_2.addWidget(self.checkBox_all_hwell, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Form_delete_therm_by_date):
        ...
        self.checkBox_all_hwell.setText(_translate("Form_delete_therm_by_date", "all H well"))
