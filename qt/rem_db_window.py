...
class Ui_rem_db(object):
    def setupUi(self, rem_db):
        ...
        self.gridLayout.addWidget(self.comboBox_mlp_rdb, 8, 1, 1, 3)
    ...
    def retranslateUi(self, rem_db):
        ...
        self.pushButton_unload_mlp.setToolTip(_translate("rem_db", "Выгрузить данные с локальной БД на удаленную"))
        self.pushButton_unload_mlp.setText(_translate("rem_db", "LOC -> REM"))
        self.pushButton_load_mlp.setToolTip(_translate("rem_db", "Загрузить данные MLP с удаленной БД на локальную"))
