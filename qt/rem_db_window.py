...
class Ui_rem_db(object):
    def setupUi(self, rem_db):
        ...
        self.gridLayout.addWidget(self.pushButton_delete_obj_rem, 1, 3, 1, 2)
        self.label_wells_count = QtWidgets.QLabel(rem_db)
        self.label_wells_count.setObjectName("label_wells_count")
        self.gridLayout.addWidget(self.label_wells_count, 2, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.pushButton_sync_wells, 2, 3, 1, 2)
        self.gridLayout_2.addLayout(self.gridLayout, 1, 1, 1, 1)
        spacerItem2 = QtWidgets.QSpacerItem(46, 17, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
