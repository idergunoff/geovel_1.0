...
class Ui_rem_db(object):
    def setupUi(self, rem_db):
        ...
        self.gridLayout_4 = QtWidgets.QGridLayout(rem_db)
        ...
        self.gridLayout_2.addWidget(self.comboBox_object_rem, 0, 1, 1, 1)
        self.comboBox_research_rem = QtWidgets.QComboBox(rem_db)
        self.comboBox_research_rem.setObjectName("comboBox_research_rem")
        self.gridLayout_2.addWidget(self.comboBox_research_rem, 0, 2, 1, 1)
