...
class Ui_rem_db(object):
    def setupUi(self, rem_db):
        ...
        spacerItem1 = QtWidgets.QSpacerItem(40, 14, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        ...
        self.pushButton_unload_mlp = QtWidgets.QPushButton(rem_db)
        ...
        self.gridLayout.addWidget(self.pushButton_unload_mlp, 8, 5, 1, 1)
        ...
        self.pushButton_delete_mlp_rdb = QtWidgets.QPushButton(rem_db)
        ...
        self.gridLayout.addWidget(self.pushButton_delete_mlp_rdb, 8, 3, 1, 1)
        ...
        self.comboBox_mlp_rdb = QtWidgets.QComboBox(rem_db)
        self.comboBox_mlp_rdb.setObjectName("comboBox_mlp_rdb")
        self.gridLayout.addWidget(self.comboBox_mlp_rdb, 8, 1, 1, 2)
        ...
        self.pushButton_load_mlp = QtWidgets.QPushButton(rem_db)
        ...
        self.gridLayout.addWidget(self.pushButton_load_mlp, 8, 4, 1, 1)
        self.pushButton_unload_ga = QtWidgets.QPushButton(rem_db)
        self.pushButton_unload_ga.setStyleSheet("background-color: rgb(255, 221, 215);")
        self.pushButton_unload_ga.setObjectName("pushButton_unload_ga")
        self.gridLayout.addWidget(self.pushButton_unload_ga, 9, 4, 1, 2)
        ...
        self.gridLayout.addWidget(self.pushButton_unload_model, 10, 5, 1, 1)
        self.pushButton_load_model = QtWidgets.QPushButton(rem_db)
        ...
        self.gridLayout.addWidget(self.pushButton_load_model, 10, 4, 1, 1)
        self.comboBox_trained_model_rdb = QtWidgets.QComboBox(rem_db)
        self.comboBox_trained_model_rdb.setObjectName("comboBox_trained_model_rdb")
        self.gridLayout.addWidget(self.comboBox_trained_model_rdb, 10, 1, 1, 2)
        self.pushButton_delete_model_rdb = QtWidgets.QPushButton(rem_db)
        ...
        self.gridLayout.addWidget(self.pushButton_delete_model_rdb, 10, 3, 1, 1)
    ...
    def retranslateUi(self, rem_db):
        ...
        self.pushButton_sync_objects.setText(_translate("rem_db", "Synchronize all objects"))
        ...
        self.pushButton_delete_obj_rem.setText(_translate("rem_db", "Delete object in RemDB"))
        ...
        self.pushButton_delete_mlp_rdb.setText(_translate("rem_db", "Delete MLP"))
        ...
        self.pushButton_unload_ga.setText(_translate("rem_db", "Synchronize genetic analysis"))
        ...
        self.pushButton_delete_model_rdb.setText(_translate("rem_db", "Delete model"))
