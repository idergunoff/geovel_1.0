...
class Ui_rem_db(object):
    def setupUi(self, rem_db):
        ...
        self.pushButton_unload_ga = QtWidgets.QPushButton(self.groupBox)
        ...
        self.gridLayout_3.addWidget(self.pushButton_unload_ga, 1, 3, 1, 2)
        ...
        self.pushButton_unload_ga_reg = QtWidgets.QPushButton(self.groupBox_2)
        self.pushButton_unload_ga_reg.setStyleSheet("background-color: rgb(255, 221, 215);")
        self.pushButton_unload_ga_reg.setObjectName("pushButton_unload_ga_reg")
        self.gridLayout_4.addWidget(self.pushButton_unload_ga_reg, 1, 3, 1, 2)
    ...
    def retranslateUi(self, rem_db):
        ...
        self.pushButton_unload_ga_reg.setText(_translate("rem_db", "Synchronize genetic analysis"))
