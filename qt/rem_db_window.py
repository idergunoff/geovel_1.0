...
class Ui_rem_db(object):
    def setupUi(self, rem_db):
        ...
        self.comboBox_genetic_rdb = QtWidgets.QComboBox(rem_db)
        self.comboBox_genetic_rdb.setObjectName("comboBox_genetic_rdb")
        self.gridLayout.addWidget(self.comboBox_genetic_rdb, 9, 1, 1, 3)
        self.label_6 = QtWidgets.QLabel(rem_db)
        self.label_6.setStyleSheet("background-color: rgb(124, 192, 255);")
        self.label_6.setObjectName("label_6")
        self.gridLayout.addWidget(self.label_6, 9, 0, 1, 1)
        self.pushButton_load_ga = QtWidgets.QPushButton(rem_db)
        self.pushButton_load_ga.setStyleSheet("background-color: rgb(206, 222, 255);")
        self.pushButton_load_ga.setObjectName("pushButton_load_ga")
        self.gridLayout.addWidget(self.pushButton_load_ga, 9, 4, 1, 1)
        self.pushButton_unload_ga = QtWidgets.QPushButton(rem_db)
        self.pushButton_unload_ga.setStyleSheet("background-color: rgb(255, 233, 196);")
        self.pushButton_unload_ga.setObjectName("pushButton_unload_ga")
        self.gridLayout.addWidget(self.pushButton_unload_ga, 9, 5, 1, 1)
    ...
    def retranslateUi(self, rem_db):
        ...
        self.pushButton_load_ga.setText(_translate("rem_db", "REM -> LOC"))
        self.pushButton_unload_ga.setText(_translate("rem_db", "LOC -> REM"))
