...
class Ui_rem_db(object):
    def setupUi(self, rem_db):
        ...
        self.pushButton_sync_entropy = QtWidgets.QPushButton(self.groupBox_3)
        self.pushButton_sync_entropy.setStyleSheet("background-color: rgb(212, 205, 255);")
        self.pushButton_sync_entropy.setObjectName("pushButton_sync_entropy")
        self.gridLayout.addWidget(self.pushButton_sync_entropy, 3, 3, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_11, 3, 0, 2, 3)
    ...
    def retranslateUi(self, rem_db):
        ...
        self.pushButton_sync_entropy.setText(_translate("rem_db", "Synchronize entropy features"))
