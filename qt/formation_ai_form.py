...
class Ui_Form_formation_ai(object):
    def setupUi(self, Form_formation_ai):
        ...
        Form_formation_ai.resize(786, 416)
        self.gridLayout_10 = QtWidgets.QGridLayout(Form_formation_ai)
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.groupBox_8 = QtWidgets.QGroupBox(Form_formation_ai)
        ...
        self.groupBox_9 = QtWidgets.QGroupBox(Form_formation_ai)
        ...
        self.groupBox_10 = QtWidgets.QGroupBox(Form_formation_ai)
        ...
        self.checkBox_save = QtWidgets.QCheckBox(Form_formation_ai)
        ...
        self.label_info = QtWidgets.QLabel(Form_formation_ai)
    ...
    def retranslateUi(self, Form_formation_ai):
        ...
        Form_formation_ai.setWindowTitle(_translate("Form_formation_ai", "Regression"))
        self.groupBox_8.setTitle(_translate("Form_formation_ai", "PCA"))
        self.checkBox_pca_mle.setText(_translate("Form_formation_ai", "mle"))
        self.groupBox_9.setTitle(_translate("Form_formation_ai", "Cross Validate"))
        self.checkBox_cross_val_save.setText(_translate("Form_formation_ai", "save"))
        self.groupBox_10.setTitle(_translate("Form_formation_ai", "Выбросы"))
        self.pushButton_lof.setText(_translate("Form_formation_ai", "LOF"))
        ...
        self.label_41.setText(_translate("Form_formation_ai", "weights:"))
        ...
        self.checkBox_save.setText(_translate("Form_formation_ai", "SAVE"))
