...
# Form implementation generated from reading ui file 'qt/form_test_model.ui'
#
...
class Ui_FormTestModel(object):
    def setupUi(self, FormTestModel):
        ...
        self.comboBox_mlp_analysis = QtWidgets.QComboBox(FormTestModel)
        self.comboBox_mlp_analysis.setObjectName("comboBox_mlp_analysis")
        self.gridLayout_2.addWidget(self.comboBox_mlp_analysis, 0, 0, 1, 1)
        ...
        self.listWidget_trained_model = QtWidgets.QListWidget(FormTestModel)
        self.listWidget_trained_model.setObjectName("listWidget_trained_model")
        self.gridLayout_3.addWidget(self.listWidget_trained_model, 0, 0, 1, 1)
