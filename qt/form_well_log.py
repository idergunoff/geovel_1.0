...
class Ui_Form_well_log(object):
    def setupUi(self, Form_well_log):
        ...
        self.tabWidget_well_log = QtWidgets.QTabWidget(Form_well_log)
        self.tabWidget_well_log.setObjectName("tabWidget_well_log")
        self.tab_logging = QtWidgets.QWidget()
        self.tab_logging.setObjectName("tab_logging")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.tab_logging)
        ...
        self.gridLayout_5.addWidget(self.pushButton_add_all, 9, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.pushButton_update_all, 10, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.pushButton_create_an, 6, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.pushButton_add_current, 8, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.pushButton_create_all_an, 7, 0, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.pushButton_to_tar_val, 0, 0, 1, 1)
        self.pushButton_to_tar_val_mr = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_to_tar_val_mr.setStyleSheet("background-color: rgb(255, 219, 175);")
        self.pushButton_to_tar_val_mr.setObjectName("pushButton_to_tar_val_mr")
        self.gridLayout_6.addWidget(self.pushButton_to_tar_val_mr, 0, 1, 1, 1)
        self.gridLayout_5.addLayout(self.gridLayout_6, 11, 0, 1, 2)
        ...
        self.label_mr_value = QtWidgets.QLabel(self.groupBox)
        self.label_mr_value.setObjectName("label_mr_value")
        self.gridLayout_5.addWidget(self.label_mr_value, 4, 1, 1, 1)
        ...
        self.tabWidget_well_log.addTab(self.tab_logging, "")
        self.tab_well_info = QtWidgets.QWidget()
        self.tab_well_info.setObjectName("tab_well_info")
        self.verticalLayout_well_info = QtWidgets.QVBoxLayout(self.tab_well_info)
        ...
        self.verticalLayout_well_info.addWidget(self.label_boundaries)
        self.listWidget_boundaries = QtWidgets.QListWidget(self.tab_well_info)
        self.listWidget_boundaries.setObjectName("listWidget_boundaries")
        self.verticalLayout_well_info.addWidget(self.listWidget_boundaries)
        self.tabWidget_well_log.addTab(self.tab_well_info, "")
        self.gridLayout_3.addWidget(self.tabWidget_well_log, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Form_well_log):
        ...
        self.label_5.setText(_translate("Form_well_log", "MedRatio:"))
        self.pushButton_to_tar_val.setToolTip(_translate("Form_well_log", "Передать среднее значение в target value"))
        self.pushButton_to_tar_val.setText(_translate("Form_well_log", "TO TARGET"))
        self.pushButton_to_tar_val_mr.setToolTip(_translate("Form_well_log", "Передать среднее значение в target value"))
        self.pushButton_to_tar_val_mr.setText(_translate("Form_well_log", "MR TO TARGET"))
        ...
        self.tabWidget_well_log.setTabText(self.tabWidget_well_log.indexOf(self.tab_logging), _translate("Form_well_log", "Каротаж"))
        self.groupBox_well_info.setTitle(_translate("Form_well_log", "Информация по скважине"))
        self.label_boundaries.setText(_translate("Form_well_log", "Границы (выберите для установки отметки)"))
        self.listWidget_boundaries.setToolTip(_translate("Form_well_log", "Выбранная граница устанавливает верхнюю отметку интервала на графике каротажа"))
        self.tabWidget_well_log.setTabText(self.tabWidget_well_log.indexOf(self.tab_well_info), _translate("Form_well_log", "Скважина"))
