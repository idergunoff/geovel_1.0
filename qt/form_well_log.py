...
class Ui_Form_well_log(object):
    def setupUi(self, Form_well_log):
        ...
        self.pushButton.setStyleSheet("background-color: rgb(255, 239, 175);")
        self.pushButton.setObjectName("pushButton")
        self.gridLayout_5.addWidget(self.pushButton, 7, 0, 1, 2)
    ...
    def retranslateUi(self, Form_well_log):
        ...
        self.pushButton.setToolTip(_translate("Form_well_log", "Передать среднее значение в target value"))
        self.pushButton.setText(_translate("Form_well_log", "TO TARGET VALUE"))
