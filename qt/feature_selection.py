...
class Ui_FeatureSelection(object):
    ...
    def retranslateUi(self, FeatureSelection):
        ...
        self.comboBox_method.setItemText(4, _translate("FeatureSelection", "Forward Selection"))
        self.comboBox_method.setItemText(5, _translate("FeatureSelection", "Backward Selection"))
        self.comboBox_method.setItemText(6, _translate("FeatureSelection", "LASSO"))
        self.comboBox_method.setItemText(7, _translate("FeatureSelection", "Random Forest"))
        self.comboBox_method.setItemText(8, _translate("FeatureSelection", "Boruta"))
