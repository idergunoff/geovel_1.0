...
# Form implementation generated from reading ui file 'torch_classfier.ui'
#
...
class Ui_TorchClassifierForm(object):
    def setupUi(self, TorchClassifierForm):
        ...
        TorchClassifierForm.resize(538, 497)
        TorchClassifierForm.setStyleSheet("")
        self.gridLayout_16 = QtWidgets.QGridLayout(TorchClassifierForm)
        ...
        self.gridLayout_13.addWidget(self.checkBox_choose_param, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_choose_lr, 0, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_choose_dropout, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_choose_decay, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.doubleSpinBox_choose_reagular, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lineEdit_choose_layers, 4, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.checkBox_tune_param, 0, 0, 1, 2)
        ...
        self.gridLayout_11.addWidget(self.lineEdit_tune_lr, 1, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.lineEdit_tune_dropout, 2, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.lineEdit_tune_decay, 3, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.doubleSpinBox_tune_regular, 4, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.lineEdit_tune_layers, 5, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.spinBox_layers_num, 6, 1, 1, 1)
        ...
        self.gridLayout_11.addWidget(self.spinBox_trials, 7, 1, 1, 1)
        self.gridLayout_14.addLayout(self.gridLayout_11, 0, 0, 1, 1)
        self.gridLayout_15.addWidget(self.groupBox_2, 0, 1, 1, 1)
        ...
        self.groupBox_3 = QtWidgets.QGroupBox(TorchClassifierForm)
        self.groupBox_3.setObjectName("groupBox_3")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.groupBox_3)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.gridLayout_10 = QtWidgets.QGridLayout()
        self.gridLayout_10.setObjectName("gridLayout_10")
        self.checkBox_stack_vote = QtWidgets.QCheckBox(self.groupBox_3)
        self.checkBox_stack_vote.setObjectName("checkBox_stack_vote")
        self.gridLayout_10.addWidget(self.checkBox_stack_vote, 0, 0, 1, 1)
        self.radioButton_stacking = QtWidgets.QRadioButton(self.groupBox_3)
        self.radioButton_stacking.setChecked(True)
        self.radioButton_stacking.setObjectName("radioButton_stacking")
        self.gridLayout_10.addWidget(self.radioButton_stacking, 0, 1, 1, 1)
        self.spinBox_models_num = QtWidgets.QSpinBox(self.groupBox_3)
        self.spinBox_models_num.setProperty("value", 3)
        self.spinBox_models_num.setObjectName("spinBox_models_num")
        self.gridLayout_10.addWidget(self.spinBox_models_num, 1, 0, 1, 1)
        self.radioButton_voting = QtWidgets.QRadioButton(self.groupBox_3)
        self.radioButton_voting.setObjectName("radioButton_voting")
        self.gridLayout_10.addWidget(self.radioButton_voting, 1, 1, 1, 1)
        self.gridLayout_3.addLayout(self.gridLayout_10, 0, 2, 1, 1)
        ...
        self.gridLayout_32.addWidget(self.checkBox_bagging, 0, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pushButton_lineup, 2, 0, 1, 1)
        ...
        self.gridLayout_7.addWidget(self.pushButton_train, 3, 0, 1, 2)
        ...
        self.gridLayout_7.addWidget(self.checkBox_save_model, 2, 1, 1, 1)
        self.groupBox_11 = QtWidgets.QGroupBox(TorchClassifierForm)
        ...
        self.gridLayout_9.addWidget(self.spinBox_pca, 0, 1, 1, 1)
        ...
        self.gridLayout_9.addWidget(self.checkBox_pca, 0, 0, 1, 1)
        self.checkBox_pca_mle = QtWidgets.QCheckBox(self.groupBox_11)
        self.checkBox_pca_mle.setObjectName("checkBox_pca_mle")
        self.gridLayout_9.addWidget(self.checkBox_pca_mle, 0, 2, 1, 1)
        self.gridLayout_7.addWidget(self.groupBox_11, 0, 0, 1, 2)
        self.groupBox_17 = QtWidgets.QGroupBox(TorchClassifierForm)
        ...
        self.gridLayout_7.addWidget(self.groupBox_17, 1, 0, 1, 2)
        self.gridLayout_8.addLayout(self.gridLayout_7, 0, 1, 4, 1)
        self.groupBox_14 = QtWidgets.QGroupBox(TorchClassifierForm)
        ...
        self.gridLayout_8.addWidget(self.groupBox_14, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.checkBox_early_stop, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.spinBox_stop_patience, 1, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.checkBox_threshold, 0, 0, 1, 1)
        ...
        self.comboBox_threshold.addItem("")
        self.comboBox_threshold.addItem("")
        self.gridLayout_6.addWidget(self.comboBox_threshold, 1, 0, 1, 1)
        self.gridLayout_8.addLayout(self.gridLayout_6, 3, 0, 1, 1)
        self.gridLayout_15.addLayout(self.gridLayout_8, 1, 1, 1, 1)
    ...
    def retranslateUi(self, TorchClassifierForm):
        ...
        self.lineEdit_tune_lr.setText(_translate("TorchClassifierForm", "0,0001-0,01"))
        ...
        self.lineEdit_tune_dropout.setText(_translate("TorchClassifierForm", "0,01-0,9"))
        ...
        self.lineEdit_tune_decay.setText(_translate("TorchClassifierForm", "0,001-0,2"))
        ...
        self.lineEdit_tune_layers.setText(_translate("TorchClassifierForm", "150-550"))
...
"<p>L-BFGS может быть целесообразен, если у вас небольшое количество параметров и вам необходима высокая точность.</p>"))
        ...
        self.groupBox_3.setTitle(_translate("TorchClassifierForm", "Ensemble"))
        self.checkBox_stack_vote.setText(_translate("TorchClassifierForm", "ON"))
        self.radioButton_stacking.setText(_translate("TorchClassifierForm", "Stacking"))
        self.radioButton_voting.setText(_translate("TorchClassifierForm", "Voting"))
        self.groupBox_16.setTitle(_translate("TorchClassifierForm", "Bagging"))
        ...
        self.groupBox_11.setTitle(_translate("TorchClassifierForm", "PCA"))
        self.checkBox_pca_mle.setText(_translate("TorchClassifierForm", "mle"))
        self.groupBox_17.setTitle(_translate("TorchClassifierForm", "PreProcess"))
        self.checkBox_stdscaler.setText(_translate("TorchClassifierForm", "StandardScaler"))
        self.checkBox_robscaler.setText(_translate("TorchClassifierForm", "RobustScaler"))
        self.checkBox_mnmxscaler.setText(_translate("TorchClassifierForm", "MinMaxScaler"))
        self.checkBox_mxabsscaler.setText(_translate("TorchClassifierForm", "MaxAbsScaler"))
        self.groupBox_14.setTitle(_translate("TorchClassifierForm", "Over Sampling"))
        self.checkBox_smote.setText(_translate("TorchClassifierForm", "SMOTE"))
        self.checkBox_adasyn.setText(_translate("TorchClassifierForm", "ADASYN"))
