...
class Ui_TorchClassifierForm(object):
    def setupUi(self, TorchClassifierForm):
        ...
        self.comboBox_threshold.addItem("")
        self.comboBox_threshold.addItem("")
        self.gridLayout_6.addWidget(self.comboBox_threshold, 5, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.checkBox_early_stop, 2, 0, 1, 1)
        self.checkBox_threshold = QtWidgets.QCheckBox(TorchClassifierForm)
        self.checkBox_threshold.setObjectName("checkBox_threshold")
        self.gridLayout_6.addWidget(self.checkBox_threshold, 4, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.spinBox_stop_patience, 3, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.groupBox_14, 1, 0, 1, 1)
