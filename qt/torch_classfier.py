...
class Ui_TorchClassifierForm(object):
    def setupUi(self, TorchClassifierForm):
        ...
        TorchClassifierForm.resize(630, 502)
        ...
        self.gridLayout_6.addWidget(self.checkBox_threshold, 5, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.checkBox_early_stop, 3, 0, 1, 1)
        ...
        self.comboBox_threshold.addItem("")
        self.comboBox_threshold.addItem("")
        self.gridLayout_6.addWidget(self.comboBox_threshold, 6, 0, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.spinBox_stop_patience, 4, 0, 1, 1)
