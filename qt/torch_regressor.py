...
# Form implementation generated from reading ui file 'qt/torch_regressor.ui'
#
...
class Ui_TorchNNRegressor(object):
    def setupUi(self, TorchNNRegressor):
        ...
        TorchNNRegressor.resize(495, 632)
        ...
        self.gridLayout_4.addWidget(self.checkBox_early_stop, 2, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.spinBox_stop_patience, 2, 2, 1, 1)
        ...
        self.spinBox_pca_ = QtWidgets.QSpinBox(self.groupBox_11)
        self.spinBox_pca_.setMaximum(1000)
        self.spinBox_pca_.setObjectName("spinBox_pca_")
        self.gridLayout_10.addWidget(self.spinBox_pca_, 0, 1, 1, 1)
