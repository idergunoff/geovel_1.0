...
class Ui_WellLoader(object):
    def setupUi(self, WellLoader):
        ...
        self.gridLayout.addWidget(self.lineEdit_layers, 1, 0, 1, 1)
        self.checkBox_deep = QtWidgets.QCheckBox(self.groupBox)
        self.checkBox_deep.setObjectName("checkBox_deep")
        self.gridLayout.addWidget(self.checkBox_deep, 1, 1, 1, 1)
    ...
    def retranslateUi(self, WellLoader):
        ...
        self.checkBox_deep.setText(_translate("WellLoader", "глубина"))
