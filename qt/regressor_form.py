...
# Form implementation generated from reading ui file 'qt/regressor_form.ui'
#
...
class Ui_RegressorForm(object):
    def setupUi(self, RegressorForm):
        ...
        self.groupBox_14 = QtWidgets.QGroupBox(RegressorForm)
        ...
        self.spinBox_n_estimators_xgb.setProperty("value", 1000)
        ...
        self.groupBox_19 = QtWidgets.QGroupBox(RegressorForm)
        ...
        self.checkBox_mask_param = QtWidgets.QCheckBox(RegressorForm)
        self.checkBox_mask_param.setObjectName("checkBox_mask_param")
        self.gridLayout_74.addWidget(self.checkBox_mask_param, 0, 0, 1, 1)
        self.listWidget_mask_param = QtWidgets.QListWidget(RegressorForm)
        self.listWidget_mask_param.setObjectName("listWidget_mask_param")
        self.gridLayout_74.addWidget(self.listWidget_mask_param, 1, 0, 1, 1)
        self.gridLayout_8.addLayout(self.gridLayout_74, 0, 1, 1, 1)
        self.gridLayout_66.addLayout(self.gridLayout_8, 1, 0, 1, 2)
        ...
        self.groupBox_15 = QtWidgets.QGroupBox(RegressorForm)
        ...
        self.spinBox_estim_lgbm.setMaximum(10000)
        self.spinBox_estim_lgbm.setSingleStep(50)
        self.spinBox_estim_lgbm.setProperty("value", 1000)
        ...
        self.pushButton_feature_selection = QtWidgets.QPushButton(RegressorForm)
        ...
        self.pushButton_search_param = QtWidgets.QPushButton(RegressorForm)
        ...
        self.groupBox_36 = QtWidgets.QGroupBox(RegressorForm)
        self.groupBox_36.setObjectName("groupBox_36")
        self.gridLayout_104 = QtWidgets.QGridLayout(self.groupBox_36)
        self.gridLayout_104.setObjectName("gridLayout_104")
        self.checkBox_cov_percent = QtWidgets.QCheckBox(self.groupBox_36)
        self.checkBox_cov_percent.setText("")
        self.checkBox_cov_percent.setObjectName("checkBox_cov_percent")
        self.gridLayout_104.addWidget(self.checkBox_cov_percent, 0, 0, 1, 1)
        self.spinBox_cov_percent = QtWidgets.QSpinBox(self.groupBox_36)
        ...
        self.gridLayout_104.addWidget(self.spinBox_cov_percent, 0, 1, 1, 1)
        self.gridLayout_103.addWidget(self.groupBox_36, 0, 0, 1, 1)
        self.pushButton_cov = QtWidgets.QPushButton(RegressorForm)
        self.pushButton_cov.setStyleSheet("background-color: rgb(210, 227, 191);")
        self.pushButton_cov.setObjectName("pushButton_cov")
        self.gridLayout_103.addWidget(self.pushButton_cov, 1, 0, 1, 1)
        self.gridLayout_102.addLayout(self.gridLayout_103, 0, 0, 1, 1)
        self.groupBox_37 = QtWidgets.QGroupBox(RegressorForm)
        self.groupBox_37.setObjectName("groupBox_37")
        self.gridLayout_105 = QtWidgets.QGridLayout(self.groupBox_37)
        self.gridLayout_105.setObjectName("gridLayout_105")
        self.checkBox_pca = QtWidgets.QCheckBox(self.groupBox_37)
        self.checkBox_pca.setText("")
        self.checkBox_pca.setObjectName("checkBox_pca")
        self.gridLayout_105.addWidget(self.checkBox_pca, 0, 0, 1, 1)
        self.checkBox_pca_mle = QtWidgets.QCheckBox(self.groupBox_37)
        self.checkBox_pca_mle.setObjectName("checkBox_pca_mle")
        self.gridLayout_105.addWidget(self.checkBox_pca_mle, 0, 2, 1, 1)
        self.spinBox_pca = QtWidgets.QSpinBox(self.groupBox_37)
        self.spinBox_pca.setMaximum(1000)
        self.spinBox_pca.setObjectName("spinBox_pca")
        self.gridLayout_105.addWidget(self.spinBox_pca, 0, 1, 1, 1)
        self.gridLayout_102.addWidget(self.groupBox_37, 0, 1, 1, 1)
        self.gridLayout_102.setColumnStretch(0, 1)
        self.gridLayout_102.setColumnStretch(1, 2)
        self.gridLayout.addLayout(self.gridLayout_102, 3, 0, 1, 3)
        ...
        self.pushButton_gen_alg = QtWidgets.QPushButton(RegressorForm)
    ...
    def retranslateUi(self, RegressorForm):
        ...
        self.comboBox_max_features_rfr.setItemText(0, _translate("RegressorForm", "sqrt"))
        self.comboBox_max_features_rfr.setItemText(1, _translate("RegressorForm", "log2"))
...
"<li><b>Tanh</b> может быть предпочтительнее, чем sigmoid, когда требуется, чтобы выходы были центрированы вокруг нуля <i>(похожая на сигмоид функция, но она отображает входные значения в диапазон от -1 до 1)</i>. </li></ul>"))
        ...
        self.checkBox_mask_param.setText(_translate("RegressorForm", "mask parameters"))
        ...
        self.pushButton_feature_selection.setToolTip(_translate("RegressorForm", "feature_selection"))
        self.pushButton_feature_selection.setText(_translate("RegressorForm", "Feat.Select."))
        ...
        self.groupBox_36.setTitle(_translate("RegressorForm", "COV"))
        self.checkBox_cov_percent.setToolTip(_translate("RegressorForm", "Не брать объекты с малым количеством скважин"))
        self.spinBox_cov_percent.setToolTip(_translate("RegressorForm", "Минимальный процент скважин для объекта для участия в расчётах"))
        self.pushButton_cov.setToolTip(_translate("RegressorForm", "CrossObjectValidation"))
        self.pushButton_cov.setText(_translate("RegressorForm", "COV"))
        self.groupBox_37.setTitle(_translate("RegressorForm", "PCA"))
