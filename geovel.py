...
check_trained_model()
print(f'check_trained_model: {datetime.datetime.now() - time}')
update_object()
print(f'update_object: {datetime.datetime.now() - time}')
update_list_object_monitor()
print('update_list_object_monitor', datetime.datetime.now() - time)
clear_current_profile()
print(f'clear_current_profile: {datetime.datetime.now() - time}')
clear_current_profile_min_max()
print(f'clear_current_profile_min_max: {datetime.datetime.now() - time}')
clear_current_velocity_model()
print(f'clear_current_velocity_model: {datetime.datetime.now() - time}')
clear_spectr()
print(f'clear_spectr: {datetime.datetime.now() - time}')
clear_window_profile()
print(f'clear_window_profile: {datetime.datetime.now() - time}')
# update_layers()
update_list_well()
print(f'update_list_well: {datetime.datetime.now() - time}')
set_info('Старт...', 'green')
set_random_color(ui.pushButton_color)
print(f'set_random_color: {datetime.datetime.now() - time}')
