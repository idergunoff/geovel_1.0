...
ui.pushButton_add_set_point_2.clicked.connect(add_train_set_point)
ui.pushButton_del_set_point_2.clicked.connect(remove_train_set_point)
...
ui.comboBox_set_point_2.activated.connect(update_train_list_point)
