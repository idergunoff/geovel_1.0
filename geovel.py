...
ui.comboBox_clust_obj.currentIndexChanged.connect(show_finite_report)
ui.comboBox_clust_obj.currentIndexChanged.connect(load_saved_auto_results_for_selected_object)
ui.comboBox_clust_obj.currentIndexChanged.connect(sync_auto_min_cluster_spinbox_with_current_object)
