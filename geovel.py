...
ui.comboBox_clust_obj.activated.connect(lambda *_: show_finite_report())
ui.comboBox_clust_obj.activated.connect(lambda *_: load_saved_auto_results_for_selected_object())
ui.comboBox_clust_obj.activated.connect(lambda *_: sync_auto_min_cluster_spinbox_with_current_object())
ui.comboBox_clust_obj.currentIndexChanged.connect(lambda *_: show_finite_report())
ui.comboBox_clust_obj.currentIndexChanged.connect(lambda *_: load_saved_auto_results_for_selected_object())
ui.comboBox_clust_obj.currentIndexChanged.connect(lambda *_: sync_auto_min_cluster_spinbox_with_current_object())
