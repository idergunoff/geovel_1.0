...
ui.toolButton_add_data_well.clicked.connect(add_data_well)
ui.toolButton_del_data_well.clicked.connect(delete_data_well)
...
ui.pushButton_save_img_all.clicked.connect(save_all_profile_images)
...
ui.pushButton_add_all_well_cls.clicked.connect(add_all_well_markup_mlp)
ui.pushButton_check_all_well_cls.clicked.connect(check_all_well_markup_mlp)
...
ui.pushButton_copy_by_except.clicked.connect(copy_regmod_by_except)
ui.toolButton_rename_regmod.clicked.connect(rename_regmod)
...
ui.pushButton_reg_check_all_well.clicked.connect(check_all_well_markup_reg)
...
ui.listWidget_trained_model_reg.currentItemChanged.connect(
    lambda current, _previous: remember_selected_trained_model_reg(current)
)
...
ui.toolButton_ix_prod_clr.clicked.connect(index_prod_clear)
...
ui.comboBox_clust_obj.activated.connect(on_cluster_object_selection_changed)
ui.comboBox_clust_obj.currentIndexChanged.connect(on_cluster_object_selection_changed)
...
ui.pushButton_cluster_remove_result_auto_tune.clicked.connect(remove_selected_cluster_auto_tune_results)
...
ui.pushButton_cluster_add_well_log.clicked.connect(add_single_well_log_parameter_to_cluster_dataset)
ui.pushButton_cluster_add_all_well_log.clicked.connect(add_all_well_log_parameters_to_cluster_dataset)
ui.pushButton_cluster_remove_well_log.clicked.connect(remove_selected_well_log_parameters_from_cluster_dataset)
ui.pushButton_cluster_clear_list_log.clicked.connect(clear_all_well_log_parameters_from_cluster_dataset)
ui.pushButton_cluster_well_log_constructor.clicked.connect(open_cluster_well_log_constructor)
