...
ui.listWidget_well_mlp.doubleClicked.connect(choose_marker_mlp)
...
print(f'4 {datetime.datetime.now() - time}')
clear_current_profile_min_max()
print(f'5 {datetime.datetime.now() - time}')
clear_current_velocity_model()
print(f'6 {datetime.datetime.now() - time}')
clear_spectr()
print(f'7 {datetime.datetime.now() - time}')
clear_window_profile()
print(f'8 {datetime.datetime.now() - time}')
# update_layers()
update_list_well()
print(f'9 {datetime.datetime.now() - time}')
set_info('Старт...', 'green')
print(f'10 {datetime.datetime.now() - time}')
set_random_color(ui.pushButton_color)
print(f'11 {datetime.datetime.now() - time}')
update_list_lda(True)
print(f'12 {datetime.datetime.now() - time}')
update_list_mlp(True)
print(f'13 {datetime.datetime.now() - time}')
update_list_reg()
print(f'14 {datetime.datetime.now() - time}')
set_param_lda_to_combobox()
print(f'15 {datetime.datetime.now() - time}')
set_param_mlp_to_combobox()
print(f'16 {datetime.datetime.now() - time}')
set_param_regmod_to_combobox()
print(f'17 {datetime.datetime.now() - time}')
set_param_expl_to_combobox()
print(f'18 {datetime.datetime.now() - time}')
update_combobox_model_ai()
print(f'19 {datetime.datetime.now() - time}')
update_list_trained_models()
print(f'20 {datetime.datetime.now() - time}')
update_list_trained_models_regmod()
print(f'21 {datetime.datetime.now() - time}')
update_list_trained_models_class()
print(f'22 {datetime.datetime.now() - time}')
check_coordinates_profile()
print(f'23 {datetime.datetime.now() - time}')
check_coordinates_research()
print(f'24 {datetime.datetime.now() - time}')
update_list_exploration()
print(f'25 {datetime.datetime.now() - time}')
update_models_expl_list()
print(f'26 {datetime.datetime.now() - time}')
update_combobox_geochem()
print(f'27 {datetime.datetime.now() - time}')
update_maket_combobox()
print(f'28 {datetime.datetime.now() - time}')
update_category_combobox()
print(f'29 {datetime.datetime.now() - time}')
update_geochem_param_train_list()
print(f'30 {datetime.datetime.now() - time}')
update_g_train_point_list()
print(f'31 {datetime.datetime.now() - time}')
check_and_create_folders()
print(f'32 {datetime.datetime.now() - time}')
update_list_binding()
print(f'33 {datetime.datetime.now() - time}')
update_list_velocity_model()
print(f'34 {datetime.datetime.now() - time}')
