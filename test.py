...
def result_analysis(results, reverse=True):
    if reverse is True:
    ...
    twenty_percent = int(len(sorted_result) * 0.8)
    ...
    analysis_plots(common_param, results, reverse=True)
    ## plots
    #
    # print('len ', len(common_param))
    # if len(common_param) > 15:
